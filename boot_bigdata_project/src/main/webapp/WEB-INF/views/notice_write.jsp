      ...
      <section id="contact" class="contact section">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row gx-lg-0 gy-4">
            ...
            <div class="col-lg-8">
              <form action="notice_write_ok" method="post" class="faqann-form" data-aos="fade" data-aos-delay="100">
                <div class="row gy-4">

                  <div class="col-md-6">
                    <input type="text" name="" class="form-control" placeholder="작성자ID" required="">
                  </div>
                  ...
                  <div class="col-md-12">
                    <input type="text" class="form-control" name="question" placeholder="질문" required="">
                  </div>

                  <div class="col-md-12">
                    <textarea class="form-control" name="answer" rows="8" placeholder="내용" required=""></textarea>
                  </div>
