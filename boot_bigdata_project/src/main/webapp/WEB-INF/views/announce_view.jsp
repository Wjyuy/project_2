	    ...
	    <div class="row gy-4">
	      ...
	      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
			<div class="services-list">
			    <c:choose>
			        <c:when test="${announce_view.id > 1}">
			            <a href="announce_view?id=${announce_view.id - 1}&total=${param.total}">이전글</a>
			        </c:when>
			        <c:otherwise>
			            <a href="#" style="pointer-events: none; color: gray;">이전글이 없습니다.</a>
			        </c:otherwise>
			    </c:choose>

			    <c:choose>
			        <c:when test="${announce_view.id < param.total}">
			            <a href="announce_view?id=${announce_view.id + 1}&total=${param.total}">다음글</a>
			        </c:when>
			        <c:otherwise>
			            <a href="#" style="pointer-events: none; color: gray;">다음글이 없습니다.</a>
			        </c:otherwise>
			    </c:choose>
			</div>
	      ...
	      <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
			<h2>${announce_view.title}</h2>
			
			<div class="meta-top">
              <ul>
                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-details.html">${announce_view.id}</a></li>
                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time datetime="2020-01-01">${announce_view.created_at}</time></a></li>
              </ul>
            </div><!-- End meta top -->
			
	        <p>
	          ${announce_view.content}
	        </p>
