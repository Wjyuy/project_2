...
public class RecallController {
	...
	@RequestMapping("/recallPage")
	public String recallPage(Model model) {
		log.info("@#recallPage");
		return "recallPage";
	}
	
    @RequestMapping("/recall")
    public String getRecallInfo(Model model, @RequestParam String vehicleNumber) {
    	log.info("@#recall");
        String recallData = recallService.getRecallInfo(vehicleNumber);
        model.addAttribute("recallData", recallData);
        return "recallPage"; // 반환할 JSP 페이지
    }
